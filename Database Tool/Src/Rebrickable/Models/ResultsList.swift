...
/// A type that maps to the JSON model used by Rebrickable API endpoints that return multiple results.
///
...
///
/// Instances of this type represent a single page of results, and contain a list of values of the associated type as well as meta data about the list.
///
